namespace eval ::optrace {
  variable script "C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.cache/wt [current_project]
  set_property parent.project_path C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.xpr [current_project]
  set_property ip_repo_paths {
  c:/PXL/devWorks/devWorks2/CAR/ip_repo
  C:/PXL/devWorks/devWorks2/CAR/eval_speedsensor_ip
} [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.srcs/constrs_1/new/FinalCarIO.xdc
