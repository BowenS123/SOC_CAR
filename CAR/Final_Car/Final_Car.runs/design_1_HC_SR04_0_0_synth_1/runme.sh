...
HD_PWD='C:/PXL/devWorks/devWorks2/CAR/Final_Car/Final_Car.runs/design_1_HC_SR04_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_HC_SR04_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_HC_SR04_0_0.tcl
