...
HD_PWD='C:/vivado_pxlsoc/ip_repo/edit_eFPGA_AXI_LM393_driver_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eFPGA_AXI_LM393_driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eFPGA_AXI_LM393_driver.tcl -notrace
