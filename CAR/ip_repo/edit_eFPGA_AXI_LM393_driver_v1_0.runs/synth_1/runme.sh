...
HD_PWD='C:/vivado_pxlsoc/ip_repo/edit_eFPGA_AXI_LM393_driver_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eFPGA_AXI_LM393_driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eFPGA_AXI_LM393_driver.tcl
